...
| — | M03 | deployed | *(teeth not yet demonstrated on the deployed gate — a deliberately broken case must be shown to turn it red, as M02 did with `d5bdce7`. A 30/30 that has never been observed failing is a claim, not a measurement)* | — | — |
